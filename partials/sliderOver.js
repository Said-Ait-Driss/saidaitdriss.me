...
const SliderOver = ({ShowSlid, setShowSlid}) => {
    return (
        <div
            className={
                ShowSlid
                    ? 'fixed inset-0 overflow-hidden z-50'
                    : 'fixed inset-0 overflow-hidden z-50 hidden'
            }
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="pointer-events-none fixed inset-y-0 left-0 flex max-w-full pr-10">
                    <div className="pointer-events-auto relative w-screen max-w-sm">
                        <div className="flex h-full flex-col  background-primary py-6 shadow-xl">
                            <div className="absolute top-0 right-0 -ml-8 flex pt-4 pr-2 sm:-ml-10 sm:pr-4">
                                <button
                                    type="button"
                                    onClick={() => setShowSlid(false)}
